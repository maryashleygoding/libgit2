...
void test_apply_index__simple_calculated(void)
{
	git_oid a_oid, b_oid;
...
void test_apply_index__simple_parsed(void)
{
	git_diff *diff;
	git_apply_options opts = GIT_APPLY_OPTIONS_INIT;
...
void test_apply_index__simple_removes_file(void)
{
	git_diff *diff;
	git_apply_options opts = GIT_APPLY_OPTIONS_INIT;
...
void test_apply_index__simple_adds_file(void)
{
	git_diff *diff;
	git_apply_options opts = GIT_APPLY_OPTIONS_INIT;
